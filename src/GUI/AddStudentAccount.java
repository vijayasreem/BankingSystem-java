...
public class AddStudentAccount extends JFrame {
        ...
        btnAdd.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                else
                {
                    ...
                    {
                        try {
                            int index = FileIO.bank.addAccount(name, bal, insname);
                            String accountNumber = generateAccountNumber(insname, index);
                            DisplayList.arr.addElement(accountNumber);
    ...
    private String generateAccountNumber(String institutionName, int sequenceNumber) {
        String seqNum = String.format("%06d", sequenceNumber);
        return institutionName + "-" + seqNum;
    }
}